...
window.addEventListener('load', () => {
	...
	styleCanvas(lab, './images/image--003.jpg', '#000');
	styleCanvas(crowd, './images/image--004.jpg', '#000');
	styleCanvas(train, './images/image--005.jpg', '#000');
	styleCanvas(impostor, './images/image--006.jpg');
	styleCanvas(dinner, './images/image--008.jpg');
	styleCanvas(find, './images/image--009.jpg');
	styleCanvas(poster, './images/image--010.jpg');
	styleCanvas(code, './images/image--011.jpg', '#000');
	styleCanvas(suitcase, './images/image--012.jpg', '#000');
	styleCanvas(safe, './images/image--013.jpg', '#000');
	styleCanvas(whiteboard, './images/image--014.jpg', '#000');
	styleCanvas(bedroom, './images/image--015.jpg', '#000');
	styleCanvas(puzzle, './images/image--016.jpg', '#000');
	styleCanvas(trains, './images/image--017.jpg', '#000');
	styleCanvas(found, './images/image--018.jpg', '#000');
});
